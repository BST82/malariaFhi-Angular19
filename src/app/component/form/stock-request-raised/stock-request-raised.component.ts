...
@Component({
  selector: 'app-stock-request-raised',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './stock-request-raised.component.html',
  styleUrls: ['./stock-request-raised.component.scss'] // ✅ Fixed property name
})
export class StockRequestRaisedComponent implements OnInit {
  form!: FormGroup;
